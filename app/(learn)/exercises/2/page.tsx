...
// หน้าแสดงรายละเอียดแบบฝึกหัดสร้างเส้นทางแบบไดนามิกด้วย App Router
export default function DynamicRoutingExercisePage() {
  // ข้อมูลแบบฝึกหัด
  const exercise = {
    id: '2',
...
ในแบบฝึกหัดนี้ คุณจะได้สร้างเส้นทางแบบไดนามิกด้วย App Router ของ Next.js โดยใช้ความรู้ที่ได้เรียนมาจากบทเรียน "พื้นฐาน App Router"

## ขั้นตอน

1. สร้างคอมโพเนนต์ \`PostPage\` ที่รับค่าพารามิเตอร์ \`id\` จาก URL
2. แสดงข้อมูลโพสต์ตาม \`id\` ที่ได้รับ
3. เพิ่มลิงก์สำหรับกลับไปยังรายการโพสต์
4. จัดสไตล์ด้วย Tailwind CSS

## เกณฑ์การให้คะแนน

- รับค่าพารามิเตอร์ \`id\` จาก URL ถูกต้อง (5 คะแนน)
- แสดงข้อมูลโพสต์ตาม \`id\` ที่ได้รับ (5 คะแนน)
- มีลิงก์สำหรับกลับไปยังรายการโพสต์ (3 คะแนน)
